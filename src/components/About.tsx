...
const founders = [
    { name: "Fatema Presswala", role: "Founder" },
    { name: "Khadija Tajpurwala", role: "Founder" },
    { name: "Arwa Khambati", role: "Founder" },
    { name: "Rashida Rampurawala", role: "Founder" },
];

export function About() {
    return (
        <section id="about" className="relative overflow-hidden bg-cream-gradient py-24 sm:py-32">
                ...
                >
                    {founders.map((f) => (
                        <motion.div
                            ...
                            className="group relative overflow-hidden rounded-[1.75rem] glass-card p-6 shadow-soft transition-shadow hover:shadow-gold flex flex-col items-center justify-center text-center h-32"
                        >
